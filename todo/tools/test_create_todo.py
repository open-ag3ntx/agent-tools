...
class TestCreateTodo:
    ...
    def test_create_single_todo(self):
        ...
        result = create_todo.invoke({"titles": ["Test task"], "task_group": "test-group"})
    ...
    def test_create_todo_has_correct_properties(self):
        ...
        create_todo.invoke({"titles": ["My task"], "task_group": "my-group"})
    ...
    def test_create_multiple_todos_in_same_group(self):
        ...
        create_todo.invoke({"titles": ["Task 1", "Task 2", "Task 3"], "task_group": "project"})
    ...
    def test_create_todos_in_different_groups(self):
        ...
        assert todo_store["frontend"][2].title == "Backend task"

    def test_create_todo_increments_id(self):
        """Should increment ID for each new todo in a group."""
        create_todo.invoke({"titles": ["Task 1", "Task 2"], "task_group": "group"})
    ...
    def test_create_todo_with_special_characters_in_title(self):
        ...
        create_todo.invoke({"titles": ["Task: with 'special' chars & symbols!"], "task_group": "group"})
    ...
    def test_create_todo_with_unicode_title(self):
        ...
        create_todo.invoke({"titles": ["任务 📝"], "task_group": "unicode-group"})
    ...
    def test_create_duplicate_title_creates_separate_todos(self):
        ...
        create_todo.invoke({"titles": ["Duplicate", "Duplicate"], "task_group": "group"})
    ...
    def test_create_returns_id_in_message(self):
        ...
        result = create_todo.invoke({"titles": ["Task"], "task_group": "group"})
        
        assert "IDs" in result or "ids" in result.lower()

    def test_empty_title(self):
        """Should handle empty title."""
        create_todo.invoke({"titles": [""], "task_group": "group"})
    ...
    def test_empty_task_group(self):
        ...
        create_todo.invoke({"titles": ["Task"], "task_group": ""})
    ...
    def test_whitespace_in_title(self):
        ...
        create_todo.invoke({"titles": ["  Spaced Task  "], "task_group": "group"})
    ...
    def test_long_title(self):
        ...
        long_title = "A" * 1000
        create_todo.invoke({"titles": [long_title], "task_group": "group"})
    ...
    def test_special_characters_in_group(self):
        ...
        create_todo.invoke({"titles": ["Task"], "task_group": "group-with_special.chars!"})
